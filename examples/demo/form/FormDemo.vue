    ...
    >
      <el-col :span="12">
        <el-form-item prop="workAge" label="工龄">
          <el-input type="small" v-model="formData.workage"></el-input>
        </el-form-item>
      </el-col>
    </ll-form>    
  </div>
...
export default {
  ...
  data() {
    ...
    return {
      formLoading: false,
      formItems: [
        { type: 'input', label: '数组绑定', prop: 'arr.0.value', order: 3, style: { color: 'red' },
          formElementProps: {
            on: { 
              change: (val, oldVal) => {
        ...
        { 
          ...
          labelRender: () => <span>昵称</span>, 
          prop: 'nickname', 
          tips: '请输入昵称',
          render: () => {
            return (
              <el-input type="text" placeholder="昵称" size="small" {...{
                props: {
        ...
        { type: 'customInput', label: 'customInput', prop: 'name', tips: 'customInput',
          fetchData: () => {
        ...
        { type: 'dialog', prop: 'dialog', label: '定制弹框', span: 12, tips: '自定义弹框', 
          formElementProps: {
            url: '/input.html',
            dialogHeight: 200,
            dialogWidth: 400,
        ...
        { type: 'inputNumber', label: '年龄', prop: 'age', formElementProps: { 
            width: 200,
            min: 1,
            max: 200,
            step: 1,
        ...
        { type: 'select', label: '职位', prop: 'role', effect: ['level'], 
          // 动态获取options
          // fetchOptions: () => {
          //   return new Promise((resolve) => {
          //     setTimeout(() => {
        ...
        { type: 'select', label: '职级', prop: 'level',
          fetchOptions: () => {
            return new Promise((resolve) => {
              setTimeout(() => {
                return resolve([
        ...
        { type: 'select', label: '头衔', prop: 'title', span: 12,
          formElementProps: {
            placeholder: '头衔',
            options: [
              { label: '工程师', children: [
        ...
        { type: 'upload', label: '头像', prop: 'avatar', span: 24,
          formElementProps: {
            multiple: true,
            autoUpload: false,
            ...
            tip: (
              <div class="el-upload__tip ll-el-upload__tip">
                只能上传jpg/png格式的图片
              </div>
            ),
        ...
        { type: 'checkbox', label: '是否同意', prop: 'agree', span: 12, formElementProps: { label: '是否同意' } },
        { type: 'checkboxGroup', label: '开通城市', prop: 'city', span: 12, formElementProps: {
            min: 1,
            options: [
        ...
        { type: 'radioButtonGroup', label: '交通工具', prop: 'transportation', span: 12, formElementProps: { 
            options: [
        ...
        { type: 'switch', label: '开关', prop: 'switcher', span: 12, formElementProps: {
            label: '开关',
            activeColor: '#13ce66',
            inactiveColor: '#ff4949'
          }
        },
        { type: 'slider', label: '进度', prop: 'progress', span: 12, formElementProps: { min: 10 } },
        { type: 'timeSelect', label: '时间', prop: 'time', span: 12, formElementProps: { 
            clearable: false, 
        ...
        { type: 'transfer', label: '穿梭框', prop: 'transfer', span: 24, formElementProps: { data: generateData() } },
      ],
      rules: {
        name: [
